...
const COLUMN_HELP_TEXT: Record<string, string> = {
  ...
  "Available Video View %":             "% of video available for all students that was actually viewed.",
  "Module":                             "Module title.",
  "Average Unique Viewers":             "Average number of users who clicked play on videos in this module.",
  "Average Available Video View %":     "Average % of video available for all students that was actually viewed in this module.",
